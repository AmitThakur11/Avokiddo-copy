...
export default function RefundAndCancellation() {
  return (
    <div>
      ...
      <div>
        <h3>Last updated on 02-01-2025 18:43:55</h3>
        <p>
          AMIT THAKUR believes in helping its customers as far as possible, and
        ...
        <ul>
          ...
          <li>
            AMIT THAKUR does not accept cancellation requests for perishable
          ...
          <li>
            ...
            his own end. This should be reported within 7 Days days of receipt
            of the products. In case you feel that the product received is not
            as shown on the site or as per your expectations, you must bring it
            to the notice of our customer service within 7 Days days of
            receiving the product. The Customer Service Team after looking into
          ...
          <li>
            ...
            Refunds approved by the AMIT THAKUR, it’ll take 3-5 Days days for
