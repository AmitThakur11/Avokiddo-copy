...
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <br />
      <div>
        <p>‌Last updated on 02-01-2025 17:44:28</p>
        <br />
        <p>
          These Terms and Conditions, along with privacy policy or other terms
          (“Terms”) constitute a binding agreement by and between AMIT THAKUR, (
        ...
        <ul>
          ...
          <li>
            ...
            be subject to the exclusive jurisdiction of the courts in gurugram,
            Haryana
          </li>
          <br />
          <br />
